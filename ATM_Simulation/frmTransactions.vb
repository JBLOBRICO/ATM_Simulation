...
Public Class frmTransactions
    ...
    Private Sub LoadTransactions(Optional searchTerm As String = "")
        Try
            ...
            Dim query As String = "SELECT TransactionID, UserID, Amount, Status, Date FROM Transactions"
            If searchTerm <> "" Then
                query &= " WHERE TransactionID LIKE @search OR UserID LIKE @search OR Status LIKE @search"
            End If
